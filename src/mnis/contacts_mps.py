...
def fetch_mps_office_addresses(
    ...
    on office addresses for each MP, with one row per combination of MP and
    office address.
    ...
    convenience that sets the from_date and to_date to the same given date.
    The on_date has priority: if the on_date is set, the from_date and
    to_date are ignored.
    ...
    :return: A dataframe of known office addresses for each MP, with one
        row per combination of MP and office address.
    """
...
def fetch_mps_email_addresses(
    ...
    on email addresses for each MP, with one row per combination of MP and
    email address.
    ...
    :param on_date: A string or date representing a date. If a string is
        ...
        '2000-12-31'. The default value is None, which means no records are
        excluded on the basis of the on_date.
    :return: A dataframe of known email addresses for each MP, with one row
        per combination of MP and email address.
    """
...
def fetch_mps_phone_numbers(
    ...
    phone numbers for each MP, with one row per combination of MP and phone
    number.
    ...
    :param on_date: A string or date representing a date. If a string is
        ...
        '2000-12-31'. The default value is None, which means no records are
        excluded on the basis of the on_date.
    :return: A dataframe of known phone numbers for each MP, with one row
        per combination of MP and phone number.
    """
...
def fetch_mps_fax_numbers(
    ...
    fax numbers for each MP, with one row per combination of MP and fax
    number.
    ...
    :param on_date: A string or date representing a date. If a string is
        ...
        '2000-12-31'. The default value is None, which means no records are
        excluded on the basis of the on_date.
    :return: A dataframe of known fax numbers for each MP, with one row per
...
def fetch_mps_websites(
    ...
    :param on_date: A string or date representing a date. If a string is
        ...
        '2000-12-31'. The default value is None, which means no records are
        excluded on the basis of the on_date.
    :return: A dataframe of known websites for each MP, with one row per
        combination of MP and website.
    """
...
def fetch_mps_blogs(
    ...
    :param on_date: A string or date representing a date. If a string is
        ...
        '2000-12-31'. The default value is None, which means no records are
        excluded on the basis of the on_date.
    :return: A dataframe of known blogs for each MP, with one row per
        combination of MP and blog.
    """
...
def fetch_mps_twitter(
    ...
    Twitter accounts for each MP, with one row per combination of MP and
    Twitter account.
    ...
    :param on_date: A string or date representing a date. If a string is
        ...
        '2000-12-31'. The default value is None, which means no records are
        excluded on the basis of the on_date.
    :return: A dataframe of known Twitter accounts for each MP, with one
        row per combination of MP and Twitter account.
    """
...
def fetch_mps_instagram(
    ...
    :param on_date: A string or date representing a date. If a string is
        ...
        '2000-12-31'. The default value is None, which means no records are
        excluded on the basis of the on_date.
    :return: A dataframe of known Instagram accounts for each MP, with one
        row per combination of MP and Instagram account.
    """
...
def fetch_mps_facebook(
    ...
    :param on_date: A string or date representing a date. If a string is
        ...
        '2000-12-31'. The default value is None, which means no records are
        excluded on the basis of the on_date.
    :return: A dataframe of known Facebook accounts for each MP, with one
        row per combination of MP and Facebook account.
    """
